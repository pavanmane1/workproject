...
class Datefilterwithoption extends StatefulWidget {
  String period;
  String option1;
  String option2;
  String label;
  Datefilterwithoption(
      {required this.period, required this.option1, required this.label, required this.option2, Key? key})
      : super(key: key);

  @override
  State<Datefilterwithoption> createState() => _DatefilterwithoptionState();
}

class _DatefilterwithoptionState extends State<Datefilterwithoption> {
          ...
          children: [
            ...
            Row(
              ...
              children: [
                ...
                ElevatedButton(
                  onPressed: () async {
                    if (_selectedValue == widget.option1) {
                      Uint8List pdf = await generatePdf(fromDate, toDate);
                      await Navigator.of(context)
                          .pushReplacement(MaterialPageRoute(builder: (context) => PdfPreviewpage(pdf_doc: pdf)));
                    }
                  },
